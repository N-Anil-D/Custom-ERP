														...
														<tr>
															<td class="pad"
																...
																<div style="font-family: Arial, sans-serif">
																	<div class=""
																		style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; mso-line-height-alt: 18px; color: #2f2f2f; line-height: 1.5;">
																		<p
																			style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 24px;">
																			<span style="font-size:16px;">Son 24 saatte bitmiş ürünlere aktarılmış olan ürünler listesi.</span></p>
																	</div>
																</div>
															</td>
														</tr>
															...
															<td class="pad"
																...
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			style="margin: 0; text-align: center; mso-line-height-alt: 16.8px; letter-spacing: 1px;">
																			<strong><span style="font-size:18px;">Bitmiş ürün detayları</span></strong></p>
																	</div>
																</div>
															</td>
														</tr>
                            ...
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff; color: #000000; width: 680px;" width="680">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 1px solid #000;">
                                                    @foreach ($data as $row)
														<table border="0" cellpadding="0" cellspacing="0" class="text_block block-2" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
															<tr>
																<td class="pad" style="padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:10px;">
																	<div style="font-family: sans-serif">
																		<div class="" style="font-size: 14px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 28px; color: #393d47; line-height: 2; padding-left:30px">
																			<p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 32px;">
																				<strong><span style="font-size:16px;"><span style="color:#5d77a9;">LOT</span></span></strong> : {{ $row->lot_no }}
																			</p>
																			<p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 32px;">
																				<strong><span style="font-size:16px;"><span style="color:#5d77a9;">Ürün</span></span></strong> : {{ $row?->item->name }}
																			</p>
																			<p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 32px;">
																				<strong><span style="font-size:16px;"><span style="color:#5d77a9;">Miktar</span></span></strong> : {{ $row->amount .' '. $row?->item?->itemToUnit->content}}
																			</p>
																			<p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 32px;">
																				<strong><span style="font-size:16px;"><span style="color:#5d77a9;">Bitmiş ürüne aktaran</span></span></strong> : {{ $row?->user->name }}
																			</p>
																			<p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 32px;">
																				<strong><span style="font-size:16px;"><span style="color:#5d77a9;">Konumu</span></span></strong> : {{ $row?->warehouse->name }}
																			</p>
																			<p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 32px;">
																				<strong><span style="font-size:16px;"><span style="color:#5d77a9;">Hedef Gönderim Tarihi</span></span></strong> : {{ $row->send_date }}
																			</p>
																			<p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 32px;">
																				<strong><span style="font-size:16px;"><span style="color:#5d77a9;">Not</span></span></strong> : {{ $row?->note }}
																			</p>
																			<p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 32px;">
																				<strong><span style="font-size:16px;"><span style="color:#5d77a9;">Durum</span></span></strong> : {{ $row?->getStatus() }}
																			</p>
																			<hr>
																		</div>
																	</div>
													...
													<table border="0" cellpadding="10" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class=""
																		style="font-size: 12px; mso-line-height-alt: 18px; color: #f9f9f9; line-height: 1.5; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
													...
													<table border="0" cellpadding="10" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class=""
																		style="font-size: 12px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #cfceca; line-height: 1.2;">
																		<p
																			style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;">
																			<span style="font-size:12px;">{{date('Y')}} © All
