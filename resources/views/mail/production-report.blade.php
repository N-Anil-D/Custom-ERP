												...
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 5px; padding-bottom: 5px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
														...
														<tr>
															<td>
																<div style="color:#000000;direction:ltr;font-family:'Ubuntu', Tahoma, Verdana, Segoe, sans-serif;font-size:18px;font-weight:700;letter-spacing:0px;line-height:120%;text-align:left;">
																	<p style="margin: 0;">&nbsp; Sayın {{ $data->name }}</p>
																</div>
															</td>
														</tr>
													</table>
													@foreach ($subData as $row)
														<table class="paragraph_block" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
															<tr>
																<td>
																	<div style="color:#000000;direction:ltr;font-family:'Ubuntu', Tahoma, Verdana, Segoe, sans-serif;font-size:14px;font-weight:600;letter-spacing:0px;line-height:120%;">
																		<p style="margin: 0;">Üretim no : # {{ Str::padLeft($row->id, 6, '0') }} #</p>
																	</div>
																</td>
															</tr>
														</table>
														<table class="list_block" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
															<tr>
																<td>
																	<ul start="1" style="margin: 0; padding: 0; margin-left: 20px; color: #000000; direction: ltr; font-family: 'Ubuntu', Tahoma, Verdana, Segoe, sans-serif; font-size: 14px; font-weight: 500; letter-spacing: 0px; line-height: 120%; text-align: left;">
																		<li style="margin-bottom: 0px;">Üretim kaydını oluşturan : <strong>{{ $row->user->name }}</strong></li>
																		<li style="margin-bottom: 0px;">Üretimin gerçekleştiği yer : <strong>{{ $row->warehouse->code.' / '. $row->warehouse->name }}</strong></li>
																		<li style="margin-bottom: 0px;">Üretilen malzeme adı : <strong>{{ $row->item->code.' / '.$row->item->name }}</strong></li>
																		<li style="margin-bottom: 0px;">Üretilen miktar : <strong>{{ $row->amount.' '.$row->item->itemToUnit->code }}</strong></li>
																		<li style="margin-bottom: 0px;">Başlangıç tarihi : <strong>{{ $row->created_at }}</strong></li>
																		<li style="margin-bottom: 0px;">Bitiş tarihi : <strong>{{ $row->updated_at }}</strong></li>
																		<li style="margin-bottom: 0px;">Üretim sorumlusunun üretime verdiği isim : <strong>{{ $row->name }}</strong></li>
																	</ul>
																</td>
															</tr>
														</table>
														<table class="paragraph_block" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
															<tr>
																<td>
																	<div style="color:#000000;direction:ltr;font-family:'Ubuntu', Tahoma, Verdana, Segoe, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;">
																		<p style="margin: 0;">Bu üretimin gerçekleşmesi için harcanan malzemeler:</p>
																	</div>
																</td>
															</tr>
														</table>
														<table class="paragraph_block" width="100%" border="1" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
															<tr style="color:#000000;direction:ltr;font-family:'Ubuntu', Tahoma, Verdana, Segoe, sans-serif;font-size:12px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;">
																<th>Ürün kodu</th>
																<th>Ürün adı</th>
																<th>Toplam miktar (fire dahil)</th>
																<th>Fire</th>
															</tr>
															@foreach($row->contents as $row2)
															<tr style="color:#000000;direction:ltr;font-family:'Ubuntu', Tahoma, Verdana, Segoe, sans-serif;font-size:12px;font-weight:400;letter-spacing:0px;line-height:120%;">
																<td>{{ $row2->item->code }}</td>
																<td>{{ $row2->item->name }}</td>
																<td style="text-align: center;">{{ $row2->amount.' '.$row2->item->itemToUnit->code }}</td>
																<td style="text-align: center;">{{ $row2->wastage.' '.$row2->item->itemToUnit->code }}</td>
															</tr>
															@endforeach
														</table>
														<br>
														...
														<tr>
															<td>
																<div style="color:#393d47;direction:ltr;font-family:'Ubuntu', Tahoma, Verdana, Segoe, sans-serif;font-size:11px;font-weight:700;letter-spacing:0px;line-height:120%;text-align:center;">
																	<p style="margin: 0;">CustomERP software</p>
																</div>
															</td>
														</tr>
													</table>
