            ...
            <tbody>
                <tr style="vertical-align: top;" valign="top">
                    <td style="word-break: break-word; vertical-align: top;" valign="top">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="txtTinyMce-wrapper"
                                                         style="font-size: 14px; line-height: 1.2; color: black; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 17px;">
                                                        <p
                                                        ...
                                                        <p
                                                            style="margin: 0; font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;">
                                                             {{ env('APP_NAME') }} için kullanıcınız oluşturulmuştur.
                                                        </p>
                                                    </div>
                                                </div>
                        ...
                        <div style="background-color:transparent;">
                            <div class="block-grid"
                                 style="min-width: 320px; max-width: 500px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; Margin: 0 auto; background-color: #e0e0e0;">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="txtTinyMce-wrapper"
                                                        ...
                                                        <br>
                                                        <p style="margin: 0; font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;">
                                                            Giriş yaptıktan sonra şifrenizi <a href="{{ url('user/profile') }}">hesabım</a> menüsünden ya da <a href="{{ url('user/profile') }}">{{ url('user/profile') }}</a>
