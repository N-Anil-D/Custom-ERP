												...
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 5px; padding-bottom: 5px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
														...
														<tr>
															<td>
																<div style="color:#000000;direction:ltr;font-family:'Ubuntu', Tahoma, Verdana, Segoe, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;">
																	<p style="margin: 0;">{{ config('app.name') }} da kayıtlı hesabınıza ait e-posta ve telefon numaranızı eşleştirmek için {{ env('EPOST_TELNO_MATCH_TOKEN_MINUTE') }} dk. boyunca geçerli olacak erişim linki aşağıdadır.</p>
																</div>
															</td>
														</tr>
													</table>
													...
													<table class="paragraph_block" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td>
																<div style="color:#000000;direction:ltr;font-family:'Ubuntu', Tahoma, Verdana, Segoe, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;">
																	<p style="margin: 0;">Butona tıklayamıyorsanız tarayıcınızın adres çubuğuna "{{ $data['link'] }}" bu linki kopyalayıp yapıştırarak CustomERP a erişim sağlayabilirsiniz.</p>
																</div>
															</td>
														</tr>
													</table>
													...
													<table class="image_block" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td style="width:100%;padding-right:0px;padding-left:0px;">
																<div align="center" style="line-height:10px"><a href="{{ url('/') }}" target="_blank" style="outline:none" tabindex="-1"><img src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/BeeProAgency/789959_773732/editor_images/logo.webp" style="display: block; height: auto; border: 0; width: 250px; max-width: 100%;" width="250" alt="CustomERP-logo" title="CustomERP-logo"></a></div>
															</td>
														</tr>
													</table>
												</td>
