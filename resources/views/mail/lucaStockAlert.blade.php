                                                ...
                                                <div
                                                    ...
                                                    <div class="txtTinyMce-wrapper"
                                                        ...
                                                        <p
                                                            ...
                                                            Sayın {{ $data->altToUsr->name }}
                                                        </p>
                                                        <p
                                                            style="margin: 0; font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;">
                                                             {{ env('APP_NAME') }} 'da kurduğunuz stok alarmı çalıştı.
                                                        </p>
                                                    </div>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="txtTinyMce-wrapper"
                                                        ...
                                                        <p style="margin: 0; font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;">
                                                            Ürün Bilgileri :  
                                                            <strong>
                                                            {{ $data->altToIte->kartKodu }} - {{ $data->altToIte->kartAdi }}
                                                            </strong>
                                                        </p>
                                                            <hr>
                                                        <p style="margin: 0; font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;">
                                                            Alarm koşulları :  
                                                            <strong>
                                                            Stok adeti {{ $data->amount }} {{ ($data->alertCondition=='<') ? 'altına düşerse' : 'üzerine çıkarsa' }}
                                                            </strong>
                                                        </p>
                                                            <hr>
