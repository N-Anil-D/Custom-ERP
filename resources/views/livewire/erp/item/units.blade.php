        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <h2 class="card-title">Birimler</h2>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input wire:model.defer="selectedArrayData.code" type="text" class="form-control @error('code') is-invalid @enderror"
                                placeholder="Birim kodunu giriniz (AD / GR / KG vb...)">
                            @error('code')
                        ...
                        <div class="mb-3">
                            ...
                            <input wire:model.defer="selectedArrayData.content" type="text" class="form-control @error('content') is-invalid @enderror"
                                placeholder="Birim açıklamasını giriniz">
                            @error('content')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
