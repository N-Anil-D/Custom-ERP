<div>
        ...
        <div class="col">
            <section class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ url('uretim/uretim_serum_barcodeTemplate_v3.xlsx') }}" class="btn btn-success btn-xs mb-2">
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group flex-wrap">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                ...
                                                <a href="{{ route('uretim.barcode-serum.download',$row->id) }}" class="dropdown-item text-1">
                                                    <i class="fas fa-file-pdf fa-lg"></i>
                                                    PDF olarak indir
                                                </a> 
                                                <a href="{{ route('uretim.barcode-serum.see',$row->id) }}" target="_blank" class="dropdown-item text-1">
    ...
    {{-- modal delete --}}
    <div class="modal fade" id="uretimSerumBrcListDeleteModal" tabindex="-1" aria-labelledby="uretimSerumBrcListDeleteModalLabel"
         aria-hidden="true">
    ...
    <div class="modal fade" id="uretimSerumBrcListInsertModal" tabindex="-1" aria-labelledby="uretimSerumBrcListInsertModalLabel"
    ...
    <script>
        window.addEventListener('uretimSerumBrcListDeleteModalShow', event => {
            $('#uretimSerumBrcListDeleteModal').modal('show');
        });
        window.addEventListener('uretimSerumBrcListDeleteModalHide', event => {
            $('#uretimSerumBrcListDeleteModal').modal('hide');
        });
        window.addEventListener('uretimSerumBrcListInsertModalShow', event => {
            $('#uretimSerumBrcListInsertModal').modal('show');
        });
        window.addEventListener('uretimSerumBrcListInsertModalHide', event => {
            $('#uretimSerumBrcListInsertModal').modal('hide');
        });
