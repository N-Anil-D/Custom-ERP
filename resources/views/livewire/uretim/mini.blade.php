<div>
        ...
        <div class="col">
            <section class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ url('uretim/uretim_mini_barcodeTemplate_v1.xlsx') }}" class="btn btn-success btn-xs mb-2">
                        <i class="fa fa-download"></i>
                        Şablonu İndir
                    </a>
                    <div class="col-lg-12 col-sm-12 pb-sm-3 pb-md-0 mb-2">
                        <input wire:model="search" type="search" class="form-control" placeholder="aramak istediğiniz listenin adını buraya yazınız.">
                    </div>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group flex-wrap">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                ...
                                                <a href="{{ route('uretim.mini.download',[Session::get('ticketType'),$row->id]) }}" class="dropdown-item text-1">
                                                    <i class="fas fa-file-pdf fa-lg"></i>
                                                    PDF olarak indir
                                                </a> 
                                                <a href="{{ route('uretim.mini.see',[Session::get('ticketType'),$row->id]) }}" target="_blank" class="dropdown-item text-1">
    ...
    {{-- modal delete --}}
    <div class="modal fade" id="uretimMiniBrcListDeleteModal" tabindex="-1" aria-labelledby="brcListDeleteModalLabel"
         aria-hidden="true">
    ...
    {{-- modal insert --}}
    <div class="modal fade" id="uretimMiniBrcListInsertModal" tabindex="-1" aria-labelledby="brcListInsertModalLabel"
    ...
    <script>
        window.addEventListener('uretimMiniBrcListDeleteModalShow', event => {
            $('#uretimMiniBrcListDeleteModal').modal('show');
        });
        window.addEventListener('uretimMiniBrcListDeleteModalHide', event => {
            $('#uretimMiniBrcListDeleteModal').modal('hide');
        });
        window.addEventListener('uretimMiniBrcListInsertModalShow', event => {
            $('#uretimMiniBrcListInsertModal').modal('show');
        });
        window.addEventListener('uretimMiniBrcListInsertModalHide', event => {
            $('#uretimMiniBrcListInsertModal').modal('hide');
        });
